...
struct CheckoutRemoteTests {
    ...
    func checksOutRemoteBranch() throws {
        ...
        let shell = MockGitShell(responses: [
            ...
            "git log -1 --pretty=format:'%an,%ae' origin/feature-2": "Test User,test@example.com",
            "git log -1 --pretty=format:'%an,%ae' origin/main": "Other User,other@example.com",
            "git checkout -b feature-2 origin/feature-2": "Switched to a new branch 'feature-2'"
        ])
        ...
        #expect(shell.commands.contains("git checkout -b feature-2 origin/feature-2"))
    ...
    func handlesAllBranchesExistLocally() throws {
        ...
        let shell = MockGitShell(responses: [
            ...
            "git config user.name": "Test User",
            "git config user.email": "test@example.com",
            "git log -1 --pretty=format:'%an,%ae' origin/feature-1": "Test User,test@example.com",
            "git log -1 --pretty=format:'%an,%ae' origin/main": "Test User,test@example.com"
        ])
    ...
    func includesAdditionalAuthors() throws {
        ...
        let shell = MockGitShell(responses: [
            ...
            "git config user.name": "Test User",
            "git config user.email": "test@example.com",
            "git log -1 --pretty=format:'%an,%ae' origin/feature-1": "Other Author,other@example.com",
            "git log -1 --pretty=format:'%an,%ae' origin/feature-2": "Test User,test@example.com",
            "git checkout -b feature-1 origin/feature-1": "Switched to a new branch 'feature-1'"
        ])
        ...
        #expect(shell.commands.contains("git checkout -b feature-1 origin/feature-1"))
    ...
    func handlesDifferentRemotePrefixes() throws {
        ...
        let shell = MockGitShell(responses: [
            ...
            "git config user.name": "Test User", 
            "git config user.email": "test@example.com",
            "git log -1 --pretty=format:'%an,%ae' upstream/feature-1": "Test User,test@example.com",
            "git log -1 --pretty=format:'%an,%ae' origin/feature-2": "Test User,test@example.com",
            "git checkout -b feature-1 origin/feature-1": "Switched to a new branch 'feature-1'"
        ])
    ...
    func filtersOtherAuthors() throws {
        ...
        let shell = MockGitShell(responses: [
            ...
            "git config user.name": "Test User",
            "git config user.email": "test@example.com", 
            "git log -1 --pretty=format:'%an,%ae' origin/feature-1": "Other User,other@example.com",
            "git log -1 --pretty=format:'%an,%ae' origin/feature-2": "Test User,test@example.com",
            "git checkout -b feature-2 origin/feature-2": "Switched to a new branch 'feature-2'"
        ])
